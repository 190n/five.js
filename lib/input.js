...
class Input {
    constructor(elem, capture = false) {
        this.actions = {};
        this._listeners = {};
        this._keyPressed = trackKeyboard(elem, capture, this._kbdCallback.bind(this));
        this._mouseButtonsPressed = [];
        this.mousePos = Vector2D(0, 0);
        trackMouse(elem, capture, this._mouseCallback.bind(this));
    }
...
export default function InputFactory(elem) {
